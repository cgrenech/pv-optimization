...
parser.add_argument('--data_tag',           type=str,  default='oxyfuel', metavar='DATATAG', help='Data tag')
parser.add_argument('--data_type',          type=str,  default='FPF', metavar='DATATAG', help='Data type, can be SLF, STLF, AI, FPF')
...
parser.add_argument('--n_epochs',           type=int,  default=300000, metavar='NEPOCHS', help='Number of epochs')
...
exec(open('oxyfuel-load-data.py').read())
